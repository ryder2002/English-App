                      ...
                      return (
                        ...
                        >
                          <CardContent className="p-4 sm:p-5">
                            <div className="flex flex-col gap-3 sm:gap-4">
                              <div className="flex-1 min-w-0">
                                <h3 className={`font-bold text-base sm:text-lg mb-1 sm:mb-2 ${isLocked
                                ...
                                <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm">
                                  <div className={`flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-0.5 sm:py-1 rounded-md sm:rounded-lg ${isLocked
