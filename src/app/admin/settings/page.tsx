    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
            <div className="container mx-auto px-3 py-4 sm:px-4 sm:py-6 md:p-6 lg:p-8 max-w-4xl">
                {/* Header với gradient */}
                <div className="mb-4 sm:mb-6 md:mb-8 rounded-xl sm:rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm p-4 sm:p-5 md:p-6 border border-gray-200/50 dark:border-gray-700/50">
                ...
                <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2">
                    ...
                    <Card className="border-0 shadow-sm bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-lg transition-all duration-300">
                        <CardHeader>
